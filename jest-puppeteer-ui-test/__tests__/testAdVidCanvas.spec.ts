...
describe("微信品专广告", () => {
  ...
  test("> q=wxadtestVidCanvas，验证混排结果页品专广告是否召回", async () => {
    try {
      await addMsg({
        context: undefined,
  ...
  test("> 验证\"了解更多 \"外链文案首府正确，点击外链，验证是否正确跳转到广告原生页", async () => {
    try {
      await addMsg({
        context: undefined,
  ...
  test("> 关注公众号，验证关注后账号\"已关注\"标签是否正常显示", async () => {
    try {
      await addMsg({
        context: undefined,
  ...
  test("> 点击热门活动1左侧菜单，验证是否正确跳转到广告原生页", async () => {
    try {
      await addMsg({
        context: undefined,
  ...
  test("> 点击热门活动1右侧菜单，验证是否正确跳转到广告原生页", async () => {
    try {
      await addMsg({
        context: undefined,
  ...
  test("> 点击热门活动2左侧菜单，验证是否正确跳转到\"唯品会特卖\"小程序", async () => {
    try {
      await addMsg({
        context: undefined,
  ...
  test("> 点击热门活动2右侧菜单，验证是否正确跳转到\"唯品会特卖\"小程序", async () => {
    try {
      await addMsg({
        context: undefined,
  ...
  test("> 点击热门活动3，验证是否正确跳转到百度首页", async () => {
    try {
      await addMsg({
        context: undefined,
  ...
  test("> 点击热门活动3行动按钮，验证是否正确跳转到百度首页", async () => {
    try {
      await addMsg({
        context: undefined,
  ...
  test("> 点击热门活动4行动按钮，验证是否正确跳转到百度首页", async () => {
    try {
      await addMsg({
        context: undefined,
  ...
  test("> 测试热门活动5，验证是否正确跳转到\"唯品会特卖\"小程序", async () => {
    try {
      await addMsg({
        context: undefined,
